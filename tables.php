                                    ...
                                    <thead>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                $title = $row['title'];
                                                echo "<option value=\"$user_id\"><tr><td> $title </td></tr></option>";
                                            }
                                        } else {
...
if (isset($_POST['submit'])) {
    ...
    $course = $_POST["course"];
    $dates = $_POST["dates"];
    mysqli_query($connection,"INSERT INTO reservation(user_id,selectoption,fullname,timess,course, dates) VALUES ('$user_id','$selectoption','$fullname', '$timess', '$course', '$dates')");
